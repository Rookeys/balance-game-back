...
public class GameResourceCommentController {
    ...
    public ResponseEntity<Boolean> addComment(
        ...
        gameService.addComment(resourceId, commentRequest, request);
        return ResponseEntity.status(HttpStatus.OK).body(Boolean.TRUE);
    }

    @Operation(summary = "게임 리소스 수정 API", description = "해당 댓글을 수정할 수 있다.")
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Boolean> updateComment(
        ...
        gameService.updateComment(commentId, commentRequest, request);
        return ResponseEntity.status(HttpStatus.OK).body(Boolean.TRUE);
    }

    @Operation(summary = "게임 리소스 삭제 API", description = "해당 댓글을 삭제할 수 있다.")
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Boolean> deleteComment(
        ...
        gameService.deleteComment(commentId, request);
        return ResponseEntity.status(HttpStatus.OK).body(Boolean.TRUE);
    }
}
